...
Evaluation of newly generated PISCES inputs (including **Panaïotis et al. 2024 DOC**, **WOA23**, **GLODAPv3**) interpolated to **ORCA2** and verified against the official **SETTE ORCA2** ground truth.
...
| **TALK** | `GLODAPv3/v2` | umol eq/L | 0.4340 | 8.006e+01 | 3.50% | 5.763e+01 | +3.990e+01 | +1.74% | `PASSED` |
| **TDIC** | `GLODAPv3/v2` | umol C/L | 0.1474 | 1.894e+02 | 9.25% | 1.465e+02 | +1.433e+02 | +7.00% | `PASSED` |
| **PiDIC** | `GLODAPv3/v2` | umol C/L | 0.1390 | 2.215e+02 | 11.10% | 1.726e+02 | +1.696e+02 | +8.50% | `PASSED` |
...
- **GLODAPv3 Inorganic Carbon System:** Captures updated modern total inorganic carbon and alkalinity distributions calibrated using Furthest-First inversion.
